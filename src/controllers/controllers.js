...
export const registerUser = async (req, res) => {
    try {
        ...
        await pool.query('INSERT INTO users (nameuser, pswduser) VALUES (?, ?)', [newUsername, newPassword]);
...
export const insertUsers = async (req, res) => {
    const { nameuser, pswduser } = req.body;
    const [rows] = await pool.query('INSERT INTO users (nameuser, pswduser) VALUES (?, ?)', [nameuser, pswduser])
    res.send('ok')
}
